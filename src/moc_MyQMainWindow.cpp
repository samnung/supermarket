...
**
** Created: Mon Aug 13 22:15:22 2012
...
static const char qt_meta_stringdata_MyQMainWindow[] = {
    "MyQMainWindow\0\0windowClosed(int)\0"
};

void MyQMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MyQMainWindow *_t = static_cast<MyQMainWindow *>(_o);
        switch (_id) {
        case 0: _t->windowClosed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData MyQMainWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyQMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MyQMainWindow,
      qt_meta_data_MyQMainWindow, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void MyQMainWindow::windowClosed(int _t1)
{
